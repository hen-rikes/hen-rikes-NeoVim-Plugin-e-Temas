...
set background=dark
  ...
  let g:colors_name="MyGruberDarker"
" }}}
" {{{ Italics
...
call <sid>hi('Exception',     s:gruberMain,      '',           '',        '')
...
call <sid>hi('MatchParen',    s:gruberBlack,      s:gruberLightBlue,    '', '')
...
call <sid>hi('VertSplit',     s:gruberBG1,        '',            '',        '')
...
call <sid>hi('Delimiter',     s:gruberMain,       '',            '',          '')
call <sid>hi('Float',         s:gruberQuartz,     '',            '',          '')
call <sid>hi('Function',      s:gruberWhite,      '',            '',          '')
call <sid>hi('Identifier',    s:gruberQuartz,     '',            '',          '')
...
call <sid>hi('Operator',      s:gruberMain,       '',            '',          '')
...
call <sid>hi('Todo',          s:gruberWhite,       s:none,            '',          '')
